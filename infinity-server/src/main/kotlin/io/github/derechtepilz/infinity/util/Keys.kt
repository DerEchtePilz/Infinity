...
import io.github.derechtepilz.infinity.util.Keys.Companion.addKey
...
enum class Keys(private val namespace: NamespacedKey, val isState: Boolean = false) {
	 ...
	 */
	STORY_STARTED(NamespacedKey(Infinity.NAME, "story_started"), true),
	INTRODUCTION_SEQUENCE(NamespacedKey(Infinity.NAME, "introduction_sequence"), true),
	INTRODUCTION_SEQUENCE_COMPLETED(NamespacedKey(Infinity.NAME, "introduction_sequence_completed"), true),
	GAMEMODE_SWITCH_ENABLED(NamespacedKey(Infinity.NAME, "gamemode_switch_enabled"), true),
	/* GAME STATE KEYS END */
