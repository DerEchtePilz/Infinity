                        ...
                        locationArgument("pos1", LocationType.BLOCK_POSITION) {
                            locationArgument("pos2", LocationType.BLOCK_POSITION) {
                                playerExecutor { player, args ->
                                    val worldName = determineWorldName(player.world.key)
                                    val structureName: String = args.getUnchecked("structureName")!!
                                    val pos1: Location = args.getUnchecked("pos1")!!
                                    val pos2: Location = args.getUnchecked("pos2")!!
                        ...
                        stringArgument("structureName") {
                            playerExecutor { player, args ->
                                ...
                                player.sendMessage(Component.text("Registering structure ")
                                    .color(NamedTextColor.YELLOW)
                                    .append(Component.text(structureName)
                                        .color(NamedTextColor.GREEN)
                                    )
                                    .append(Component.text(" for world ")
                                        .color(NamedTextColor.YELLOW)
                                    )
                ...
                literalArgument("load") {
                    textArgument("structure") {
                        ...
                        playerExecutor { player, args ->
                            ...
                            player.sendMessage(Component.text(structureFile.name))
                        }
                    }
                }
            }
